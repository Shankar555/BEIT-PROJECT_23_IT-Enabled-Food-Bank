...
<div class="main">
  ...
  <p><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#adddonor">Donate Food</button></p> <br />           
  ...
  <ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#menu1">Events food&nbsp;</a></li>
    <li><a data-toggle="tab" href="#menu2">Resturent food &nbsp;</a></li>
    <li><a data-toggle="tab" href="#menu3">Self food &nbsp;</a></li>
    <li><a data-toggle="tab" href="#menu4">Others food &nbsp;</a></li>
  </ul>
...
?></p>
    ...
    <div id="menu2" class="tab-pane fade">
      <h3>Donors With Resturent food</h3>
      <p><?php 
