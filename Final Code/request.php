...
<div class="main">
  ...
  <p><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#needblood">Request For Food</button></p> <br />           
...
<div class="modal fade" id="needblood" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Need For Food</h4>
        </div>
        <div class="modal-body">
        <form action="need_flood.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
           ...
           <select name="group" class="form-control">
             <option value="Events food">Events food </option>
             <option value="Resturent food"> Resturent food</option>
             <option value="Self food">Self food </option>
          ...
          <div class="form-group">
            <input type="text" class="form-control" name="Location" id="Location" placeholder="Enter Location"></input>
          </div>
